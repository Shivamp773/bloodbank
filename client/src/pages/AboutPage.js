        ...
        <Layout>
            <div className="container">
                <div className='d-felx flex-column mt-4'>
                    ...
                    <h3>Made with <i class="fa-solid fa-heart"></i> By Shivam Pandey </h3>
                    <hr />
                    ...
                    <p>
                        ...
                        <a href='https://mail.google.com/mail/u/0/#inbox?compose=new' className='anc' target="_blank">Gmail : spandey.7773@gamil.com</a>
                    </p>
                    <p>
                        <i class="fa-solid fa-brands fa-github text-success"></i>
                        <a href='https://github.com/Shivamp773' className='anc' target="_blank">GitHub : Shivamp773</a>
                    </p>
